...
{
    public class GripperPublisher_demo : Publisher<Messages.Sensor.Joy>
    {
        ...
        private void Update()
        {
            ...
            activate_gripper = test_tran.active_gripper;
            reset = test_tran.reset;

            if (test_tran.finger_lb == 1 && gripper_state == 0)
            {
                command = 1;
                gripper_state = 1;
            }
            if (test_tran.finger_lb == 0 && gripper_state == 1)
            {
                command = 2;
                gripper_state = 0;
            }
