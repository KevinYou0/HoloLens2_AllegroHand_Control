...
public class CSVWritter_HxY : MonoBehaviour
{
    ...
    public GameObject LuminSensor, PupilRecorder, DataRecorder, LumCam, RobotEndEffector;
    ...
    public HelloWorld ui_info;
    public CalibPos moving_info;
    ...
    void InitializeCSV()
    {
        ...
        writer.WriteLine("SerialNumber,WorldTime,WorldTime(seconds),WorldTime(MiliSecond),Time.time,FrameNum,ExpStarted,GrippedForInsert," +
            ...
            "Lum_Sensor,Lum_RGB,PupilDiameter,PupilID,CogLoad,markerX," + "command_status,"  +
    ...
    void WriteCSV()
    {
        ...
        LightSensorValue + "," + LightCalculateValue + "," + PupilDiameter + "," + PupilID + "," + CogLoad + "," + markerX + "," + moving_info.command_status + "," + "," +
